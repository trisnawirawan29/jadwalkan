...
@section('content')
    <div class="content-card">
        ...
        <form method="GET" class="row g-2 mb-4">
            ...
            <div class="col-md-3"><select name="role" class="form-select"><option value="">Semua role</option><option value="admin" @selected(request('role') === 'admin')>Admin</option><option value="manager" @selected(request('role') === 'manager')>Manager</option><option value="provider" @selected(request('role') === 'provider')>Provider</option><option value="user" @selected(request('role') === 'user')>User</option></select></div>
